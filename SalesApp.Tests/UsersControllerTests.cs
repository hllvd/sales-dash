...
namespace SalesApp.Tests
{
    public class UsersControllerTests
    {
        ...
        public async Task GetUsers_AdminRole_ReturnsPagedUsers()
        {
            ...
            _mockUserRepository.Setup(x => x.GetAllAsync(1, 10, It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<HashSet<Guid>?>(), It.IsAny<bool>(), It.IsAny<string>())).ReturnsAsync((users, 2));
