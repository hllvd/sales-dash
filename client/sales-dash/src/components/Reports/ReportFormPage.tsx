      ...
      <div style={{ padding: '20px', maxWidth: '1440px', margin: '0 auto' }}>
        <Group justify="space-between" mb="xl">
          <Stack gap={2}>
            ...
            <Text size="xs" c="dimmed">Configure filtros, agrupamentos e colunas para criar um relatório gerencial sob medida.</Text>
          </Stack>
          <Group>
            {isEditMode && (
              <Button 
        ...
        <Grid gutter="xl">
          ...
          {/* Right Column - RESULTS PREVIEW (Sticky) */}
          <Grid.Col span={{ base: 12, lg: 6.5 }}>
            ...
            >
                  ...
                  <Center style={{ height: '100%', padding: '24px' }}>
                    <Stack align="center" gap="md" style={{ textAlign: 'center', maxWidth: '360px' }}>
                      <Text size="sm" c="dimmed" style={{ lineHeight: 1.5 }}>
                        Defina o nome do relatório, adicione colunas e clique no botão acima para rodar a prévia em tempo real com dados reais do banco de dados.
                      </Text>
                      <Button 
                        variant="outline" 
                        color="indigo"
              ...
              <Group justify="flex-end" mt="md" gap="sm" style={{ borderTop: '1px solid #e9ecef', paddingTop: '12px' }}>
