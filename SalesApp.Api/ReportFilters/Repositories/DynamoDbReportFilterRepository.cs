    ...
    public class DynamoDbReportFilterRepository : IReportFilterRepository
    {
        ...
        private static Dictionary<string, AttributeValue> ToAttributeMap(ReportFilter f)
        {
            var item = new Dictionary<string, AttributeValue>
            {
                ...
                { "groupByClassification", new AttributeValue { BOOL = f.GroupByClassification } },
                { "hideUnassignedTeams", new AttributeValue { BOOL = f.HideUnassignedTeams } },
                ...
                { "countActiveUsers", new AttributeValue { BOOL = f.CountActiveUsers } },
        ...
        private static ReportFilter MapToModel(Dictionary<string, AttributeValue> item)
        {
            ...
            return new ReportFilter
            {
                ...
                HideUnassignedTeams = item.GetValueOrDefault("hideUnassignedTeams")?.BOOL ?? false,
                ...
                CountActiveUsers = item.GetValueOrDefault("countActiveUsers")?.BOOL ?? false,
