...
namespace SalesApp.Repositories
{
    ...
    public interface IUserRepository
    {
        ...
        Task<(List<User> Users, int TotalCount)> GetAllAsync(int page, int pageSize, string? search = null, string? contractNumber = null, HashSet<Guid>? allowedUserIds = null, bool activeOnly = false, string status = "active");
