...
- `SalesApp.Api/Services/ImportExecutionService.cs` — Added `ResolveContractNumber`, updated `existingMap` dictionary keys with case-insensitivity, and added duplicate guards.
